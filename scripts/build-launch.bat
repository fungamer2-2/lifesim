...
g++ -Wall -o main.exe main.o generateStat.o vehicle.o person.o mainCharacter.o parent.o teacher.o school.o instring.o inint.o menu.o getTXT.o game.o relationType.o
del *.o
