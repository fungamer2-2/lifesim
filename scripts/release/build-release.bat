...
g++ -Wall -O3 -o main.exe main.o vehicle.o person.o mainCharacter.o parent.o teacher.o school.o occupation.o exceptions.o instring.o inint.o menu.o getTXT.o game.o getType.o generateStat.o
